...
static constexpr auto ungapped_view = minstrobe_hash(ungapped_shape,
                                                  3,5,
                                                  seqan3::seed{0});
static constexpr auto ungapped_3_view = minstrobe_hash(ungapped_shape,
                                            2,6,
                                            seqan3::seed{0});
...
TEST_F(minstrobe_hash_test, ungapped)
{
    ...
    EXPECT_THROW((text3 | minstrobe_hash(ungapped_shape, 1,5)), std::invalid_argument);
}
...
TEST_F(minstrobe_hash_test, gapped)
{
    ...
    EXPECT_THROW((text3 | minstrobe_hash(gapped_shape, 1,6)), std::invalid_argument);
}
